...
The full security and privacy explanation belongs with the installed file: once published, read the opening comment in `aeries-playground.user.js`. It documents page access, every requested permission and schedule endpoint, saved data, update behavior, safeguards, and remaining limitations. See the [README](README.md) for source availability and installation. This page summarizes the available controls and explains how to report a concern.
